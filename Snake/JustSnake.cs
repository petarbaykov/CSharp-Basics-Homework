...
{  
    static void Main()
    {
        ...
        while (true)           
        {
            ...
            Position snakeNewHead = new Position(snakeHead.row + newDirection.row,
            snakeHead.col + newDirection.col);
            ...
            if(Environment.TickCount-lastFoodTime>=foodDisaspearTime)
            {
